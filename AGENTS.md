...
- **Content Depth:** Mọi bài viết (cả VN và EN) phải có tối thiểu **3000 từ**. Sử dụng thước đo `wc -w` trên nội dung markdown (loại bỏ front matter) để kiểm tra. Đồng thời, mỗi bài phải bao gồm ít nhất 2 external links (trỏ đến nguồn tham khảo uy tín bên ngoài) để tăng giá trị SEO. Internal links chỉ thêm khi có bài viết thật trong blog, không tạo link placeholder/fake. Nếu không có bài cùng chủ đề, bỏ qua internal link.
