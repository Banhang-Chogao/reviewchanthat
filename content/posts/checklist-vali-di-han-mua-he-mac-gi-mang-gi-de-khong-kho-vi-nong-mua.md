...
image_attribution_checked_at = "2026-07-10T18:56:34+07:00"
...
seo_title = "Checklist vali đi Hàn mùa hè: mặc gì, mang gì để không khổ"
...
tags = ["checklist", "vali đi Hàn Quốc", "du lịch Hàn Quốc", "mùa hè Hàn Quốc", "series du lịch"]
...
collapsed = false
enabled = true
items = ["Chuẩn bị vali đi Hàn Quốc mùa hè cần chú trọng quần áo thoáng mát, đồ chống nắng và áo mưa gấp gọn.", "Nên mang 5–7 bộ quần áo, giày thể thao + dép, túi chống nước và kem chống nắng SPF 50+.", "Checklist chi tiết theo danh mục giúp bạn không quên món đồ quan trọng nào."]
title = "Tóm tắt bài viết"

[attribution]
copyright = "© 2026 Review Chân Thật. Bài viết tham khảo và tổng hợp từ các nguồn du lịch uy tín."
source_note = "Bài viết tổng hợp từ kinh nghiệm thực tế và tham khảo từ https://english.visitkorea.or.kr."

[[checklist]]
items = ["Hộ chiếu (còn hạn 6 tháng)", "Visa Hàn Quốc (nếu cần)", "KVE (K-ETA) bản in / ảnh chụp", "Bảo hiểm du lịch", "Đặt phòng, vé máy bay (bản mềm)"]
title = "Giấy tờ"

[[checklist]]
items = ["Áo thun cotton/lanh (5–7 cái)", "Quần short / chân váy (3–4 cái)", "Đầm maxi (2 cái — đi biển, đi chơi tối)", "Áo khoác mỏng / áo chống nắng", "Đồ bơi (nếu đi biển, công viên nước)", "Áo mưa gấp gọn (bắt buộc)"]
title = "Quần áo"

[[checklist]]
items = ["Giày thể thao thoáng khí", "Dép quai hậu / sandal"]
title = "Giày dép"

[[checklist]]
items = ["Kem chống nắng SPF 50+", "Sữa rửa mặt, dưỡng ẩm", "Lăn khử mùi", "Khăn giấy ướt", "Băng vệ sinh (nếu cần)"]
title = "Mỹ phẩm & vệ sinh"

[[checklist]]
items = ["Sạc dự phòng (10.000 mAh+)", "Cáp sạc (nhiều loại)", "Adapter chuyển đổi (Hàn dùng 2 chấu tròn)", "Tai nghe", "Máy ảnh (nếu có)"]
title = "Đồ điện tử"

[[checklist]]
items = ["Thuốc cảm, đau bụng", "Băng cá nhân", "Thuốc chống muỗi", "Men tiêu hóa"]
title = "Thuốc & y tế"

[[checklist]]
items = ["Túi chống nước (cho điện thoại)", "Mũ rộng vành", "Kính râm", "Túi đựng đồ ướt", "Gối cổ (máy bay)"]
title = "Khác"

[[faq]]
answer = "Vải cotton, lanh, modal — thoáng mát, thấm hút mồ hôi. Áo thun, váy, quần short."
question = "Mặc gì cho mát?"

[[faq]]
answer = "Kem chống nắng SPF 50+, mũ rộng vành, kính râm, áo chống nắng."
question = "Cần đồ chống nắng gì?"
...
title = "Đi Hàn mùa hè mặc gì cho đẹp?"
...
[[tom_tat_nhanh]]
label = "Loại vali"
value = "Cabin 7kg hoặc ký gửi 20kg"

[[tom_tat_nhanh]]
label = "Đồ chính"
value = "5–7 bộ quần áo"
...
[[tom_tat_nhanh]]
label = "Mẹo"
value = "Gấp gọn, dùng túi hút chân không"
+++

Chuẩn bị vali cho chuyến đi Hàn Quốc mùa hè không khó — chỉ cần biết mang gì và bỏ gì. Bài viết này là checklist đầy đủ giúp bạn không quên thứ gì.

## Nguyên tắc đóng vali

- **Ít hơn bạn nghĩ:** Bạn có thể giặt đồ tại Hàn hoặc mua thêm.
- **Phân loại:** Giấy tờ → quần áo → giày dép → mỹ phẩm → đồ điện tử → thuốc.
- **Gấp gọn:** Cuộn tròn quần áo thay vì gấp phẳng. Dùng túi hút chân không nếu vali nhỏ.

## Mặc gì?

Xem bài viết riêng: [Đi Hàn mùa hè mặc gì cho đẹp mà không nóng]({{< ref "posts/di-han-mua-he-mac-gi-cho-dep-ma-khong-nong" >}}).

## Lưu ý thời tiết

- **Mưa:** Luôn mang áo mưa gấp gọn trong túi.
- **Nắng:** Kem chống nắng thoa lại sau 2 giờ.
- **Độ ẩm:** Quần áo lâu khô — mang thêm 1–2 bộ dự phòng.

## Vali cabin 7kg hay ký gửi 20kg?

- **7kg:** Đủ nếu đi 5 ngày, giặt đồ tại Hàn.
- **20kg:** Thoải mái hơn, có thể mua sắm mang về.
