...
commit = "25880a45"
description = "Playbook chẩn đoán lỗi CI/CD khi deploy Hugo qua GitHub Actions + Pages: phân biệt lỗi hạ tầng và lỗi code, khi nào nên autofix an toàn, khi nào không."
draft = false
