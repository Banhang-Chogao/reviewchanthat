...
seo_title = "Post date timezone Việt Nam (GMT+7): tránh stale date"
...
[[faq]]
question = "Hỏi: Date “hôm qua” nhưng vừa tạo bài?"
answer = "Trả lời: Thường do stamp UTC gần nửa đêm VN, hoặc date-only bị parse UTC. So file `date` với giờ máy VN và log CI."

[[faq]]
question = "Hỏi: Có cho phép future date?"
answer = "Trả lời: Không — coi là fake. Rule pre-deploy fail hoặc kéo về “now” VN khi `--fix`."

[[faq]]
question = "Hỏi: PR chỉ đổi CSS có bị fail date post cũ?"
answer = "Trả lời: Nên **scope QA theo diff**. Quét 150 bài mỗi PR UI tạo baseline debt chặn deploy không liên quan — xem [baseline debt](/posts/baseline-debt-chan-deploy-va-qa-scope-chi-bat-tinh-nang-moi/)."
